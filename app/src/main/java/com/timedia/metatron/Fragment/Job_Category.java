...
import com.timedia.metatron.Adapter.Job_Category_Adapter;
import com.timedia.metatron.R;

public class Job_Category extends Fragment {
    ...
    private void Variableinit(final View view) {
        ...
        Job_Category_Adapter aAdapter = new Job_Category_Adapter(getChildFragmentManager());
        aAdapter.addFrag(new Assigned_Jobs_Fragment(), "Assigned");
        aAdapter.addFrag(new UNAssigned_Jobs_Fragment(), "Un Assigned");
        aView_Pager.setAdapter(aAdapter);
        aView_Pager.setOffscreenPageLimit(1);
