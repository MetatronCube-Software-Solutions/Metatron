...
public class UnAssigned_Jobs_Adapter extends RecyclerView.Adapter<UnAssigned_Jobs_Adapter.ViewHolder> {

    private ArrayList<JobList_Response.JobsList> mJobsList;
    private Context mContext;
    private Jobs_Onclick mJobs_Onclick;

    public UnAssigned_Jobs_Adapter(Context aContext, ArrayList<JobList_Response.JobsList> aJobsList, Jobs_Onclick aJobs_Onclick) {
    ...
    @NonNull
    @Override
    public UnAssigned_Jobs_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new UnAssigned_Jobs_Adapter.ViewHolder(LayoutInflater.from(parent.getContext())
    ...
    @SuppressLint("NewApi")
    @Override
    public void onBindViewHolder(@NonNull UnAssigned_Jobs_Adapter.ViewHolder holder, int position) {
        ...
        holder.mEdit_icon.setVisibility(View.GONE);
    }
